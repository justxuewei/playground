...
type EchoClient interface {
	Ping(ctx context.Context, in *EchoRequest, opts ...grpc_go.CallOption) (*EchoResponse, common.ErrorWithAttachment)
}
...
type EchoClientImpl struct {
	Ping func(ctx context.Context, in *EchoRequest) (*EchoResponse, error)
}
...
func (c *echoClient) Ping(ctx context.Context, in *EchoRequest, opts ...grpc_go.CallOption) (*EchoResponse, common.ErrorWithAttachment) {
	out := new(EchoResponse)
	interfaceKey := ctx.Value(constant.InterfaceKey).(string)
	return out, c.cc.Invoke(ctx, "/"+interfaceKey+"/Ping", in, out)
}
...
func (UnimplementedEchoServer) Ping(context.Context, *EchoRequest) (*EchoResponse, error) {
...
func _Echo_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc_go.UnaryServerInterceptor) (interface{}, error) {
	in := new(EchoRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	...
	invo := invocation.NewRPCInvocation("Ping", args, invAttachment)
	if interceptor == nil {
		result := base.XXX_GetProxyImpl().Invoke(ctx, invo)
		return result, result.Error()
	}
