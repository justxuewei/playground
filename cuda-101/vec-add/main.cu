...
void explicitMemExample(int vectorLength)
{
	...
	// Allocate Host Memory using cudaMallocHost API. This is best
	// practice when buffers will be used for copies between CPU and GPU
	// memory.
	...
	//
	// cudaMemcpyDefault: CUDA figures out the copy direction
	// automatically from the pointer addresses. In this case,
	// cudaMemcpyDefault == cudaMemcpyHostToDevice
	//
	// The kind argument can be:
